...
const Navbar = () => {
    ...
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <ul className={`nav1 nav2 ${visible? "w-full":"w-0"}`} >
            <div onClick={()=>setVisible(false)} className={`flex cursor-pointer items-center gap-4 p-3 ${visible? "block":"hidden"}`}>
        ...
        <div className='flex items-center gap-6'>
            ...
            <div className='group relative'>
                ...
                <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                    <div className='absolute left-[-70px] top-[-5px] flex flex-col gap-2  w-36 py-3 px-5 bg-slate-100, text-gray-500 rounded'>
